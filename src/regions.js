...
request('https://www.credit-agricole.fr')
.then(body => {
  ...
  fs.writeFileSync(path.join(__dirname, '..', 'regions.json'), JSON.stringify(result, null, 2))
  console.log(`The list of regions is written in ${path.resolve('../regions.json')}`)
})
